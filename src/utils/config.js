...
export const MODEL_CONFIG = {
  ...
  GENERATIVE: {
    MODEL_NAME: 'Xenova/LaMini-Flan-T5-77M',
    MAX_NEW_TOKENS: 120,
    DTYPE: 'q4',
    PARAMS: [
      { temperature: 0.35, top_p: 0.85, do_sample: true },
      { temperature: 0.20, top_p: 0.90, do_sample: true },
      { temperature: 0.55, top_p: 0.80, do_sample: true }
    ]
  }
};
